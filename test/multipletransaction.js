const MultipleTransaction = artifacts.require('SplitPayment');

contract('Multiple Transaction', (accounts) => {
  let multipleTransaction;
  before(async () => {
    multipleTransaction = await MultipleTransaction.deployed();
  });

  it('Should multiple payment', async () => {
    ...
    await multipleTransaction.send(
      recipients,
      amounts,
